...
export default function RulePage() {
  return (
    <ChakraProvider>
      <div className="">
        <div className="relative bg-[#5FC7FF] h-full">
          ...
          <div className="absolute z-20 top-5 w-full flex justify-center items-center flex-col">
            <Flex
              alignItems="center"
          ...
          <div className="relative h-[700px] overflow-y-auto bg-black rounded-3xl m-8 top-[20%] bg-opacity-50 p-4">
            <Container className="text-white text-opacity-100">
              <Stack spacing={3}>
